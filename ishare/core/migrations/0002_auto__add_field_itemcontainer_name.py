...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ItemContainer.name'
        db.add_column('core_itemcontainer', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ItemContainer.name'
        db.delete_column('core_itemcontainer', 'name')
